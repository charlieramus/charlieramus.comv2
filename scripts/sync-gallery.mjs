 ...
 *
 * `public/photos/gallery.json` is the hand-authored source of truth for the "All"
 * grid. Each entry is
 *   { "file": "<name>.webp", "caption": "...", "location"?: "...", "featured"?: true }.
 * (The "By trip" view is a SEPARATE, folder-driven dataset — see the TRIPS pass
 * below and data/trip-photos.ts.)
